...
namespace Aggregates.Internal
{
    public class NSBUnitOfWork : UnitOfWork, IMutate
    {
        ...
        public NSBUnitOfWork(ILogger<NSBUnitOfWork> logger, IRepositoryFactory repoFactory, IEventFactory eventFactory, IVersionRegistrar registrar) : base(logger, repoFactory, eventFactory)
        {
